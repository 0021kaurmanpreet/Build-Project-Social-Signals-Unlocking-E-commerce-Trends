...
def run_transformation_script():
    ...
    """
    subprocess.run(["python", "C:\\Users\\kaur6\\Downloads\\BuildProject-ECommerce\\transforming_tables.py"], check=True)

# Database connection details
USERNAME = "root"        # Username for the database
PASSWORD = "password"  # Password for the database (avoid hardcoding passwords in production)
